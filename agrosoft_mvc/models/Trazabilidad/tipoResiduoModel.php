...
class TipoResiduo {
    ...
    public function create() {
        ...
        if ($stmt->execute()) {
            ...
            $error = $stmt->errorInfo();
            die("Error al crear tipo de residuo: " . $error[2]);
        }
    }
    ...
    public function update() {
        ...
        if ($stmt->execute()) {
            ...
            $error = $stmt->errorInfo();
            die("Error al actualizar tipo de residuo: " . $error[2]);
        }
    }
    ...
    public function delete() {
        ...
        if ($stmt->execute()) {
            ...
            $error = $stmt->errorInfo();
            die("Error al eliminar tipo de residuo: " . $error[2]);
        }
    }
}
?>
